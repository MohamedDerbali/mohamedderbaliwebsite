...
function App() {
  ...
  const sendMailToMohamed = async (e) => {
    if (
      ...
      window.open(
        `mailto:mohamed.derbali@esprit.tn?subject=${mailProperties.subject}&body=${mailProperties.message}%0D%0Aphone:${mailProperties.phone}`
      );
      return;
    }
  ...
  return (
    <div className="App" id="home">
      ...
      <div className="aboutMe" id="aboutMe">
        ...
        <Link to="techs" spy={true} smooth={true} style={{ width: "100%" }}>
      ...
      <div className="techs" id="techs">
        <h1 className="basicText">Languages and Tools</h1>
        <p align="left">
          {" "}
          <a
          ...
          <a href="https://nodejs.org" target="_blank" rel="noreferrer">
            {" "}
            <img
              src="[https://raw.githubusercontent.com/devicons/devicon/master/icons/nodejs/nodejs-original-wordmark.svg](https://raw.githubusercontent.com/devicons/devicon/master/icons/nodejs/nodejs-original-wordmark.svg)"
              alt="nodejs"
              width="40"
              height="40"
            />{" "}
